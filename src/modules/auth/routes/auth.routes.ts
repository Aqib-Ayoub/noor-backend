...
import { sendOtp, verifyOtp, completeRegistration, adminLogin } from '../controllers/auth.controller';
...
/** POST /api/auth/complete-registration — new users submit name after OTP */
