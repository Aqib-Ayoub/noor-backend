...
// ─── Masjid Registration ──────────────────────────────────────────────────────
// Imam is NOT collected at registration — set later in manage screen.
...
/** Admin sets actual clock times per prayer (from the drum picker). "HH:mm" 24hr format. */
...
// ─── Masjid Settings (all editable from manage screen) ───────────────────────
