...
import {
  ...
  removeFamily,
  getLeaderboard,
} from '../modules/masjid/masjid.controller';
...
// ── Settings (imam, account number, masjid phone) ────────────────────────────
...
// ── Leaderboard ───────────────────────────────────────────────────────────────
// Any authenticated member of the masjid can view the leaderboard
